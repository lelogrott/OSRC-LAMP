...
set style line 5 lc rgb  '#2a8f1e' pt 5  ps 1 lt 1 lw 1
set style line 6 lc rgb  '#8b1a0e' pt 6  ps 1 lt 1 lw 1
...
plot "data_cp_real/times"           using 1:3   title 'Real'            with linespoints ls 2, \
      mean_y2                                   title 'Média'           with lines       ls 4, \
      mean_y2+stddev_y2                         title 'Desvio Padrão'   with lines       ls 6, \
      mean_y2-stddev_y2                       notitle                   with lines       ls 6
#
