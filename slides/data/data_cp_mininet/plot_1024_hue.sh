...
plot "1024_log_zoado"        using (($0)+1):1   title '1024Mb alterado'                 with lines ls 1, \
     "1024_log_zoado"        using (($0)+1):1 notitle                   smooth sbezier  with lines ls 2
#     "1024_log"              using (($0)+1):1   title '1024Mb'                          with lines ls 3, \
#     "1024_log"              using (($0)+1):1 notitle                   smooth sbezier  with lines ls 4
