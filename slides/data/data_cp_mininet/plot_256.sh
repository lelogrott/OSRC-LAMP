...
#f(x) = mean_y
#fit f(x) '256_log' u ($0+1):1 via mean_y
...
plot "256_log"        using (($0)+1):1   title '256Mb'                  with lines ls 1, \
     "256_log"        using (($0)+1):1 notitle          smooth sbezier  with lines ls 2
