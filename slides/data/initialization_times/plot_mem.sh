...
set xlabel "Tamanho (parametro n)"
set autoscale

set ylabel "Consumo de memoria (Megabytes)"
set title  "Consumo de memória do Mininet"
...
plot "output_minimal.log"    using         1:2   title 'Linear'                   with      points ls 1, \
     "output_minimal.log"    using         1:2 notitle                            with lines       ls 1, \
     "output_tree.log"       using (2**($1)):2   title 'Tree'                     with      points ls 3, \
     "output_tree.log"       using (2**($1)):2 notitle            smooth cspline  with lines       ls 3, \
     "output_single.log"     using         1:2   title 'Single'                   with      points ls 4, \
     "output_single.log"     using         1:2 notitle            smooth cspline  with lines       ls 4
#     "output_reversed.log"   using         1:2   title 'Reversed'                 with      points ls 2, \
#     "output_reversed.log"   using         1:2 notitle                            with lines       ls 2, \
