...
set ylabel "Tempo (s)"
set title  "Tempo de inicialização do Mininet"
...
plot "output_minimal.log"    using         1:3   title 'Linear'                   with      points ls 1, \
     "output_minimal.log"    using         1:3 notitle                            with lines       ls 1, \
     "output_tree.log"       using (2**($1)):3   title 'Tree'                     with      points ls 3, \
     "output_tree.log"       using (2**($1)):3 notitle            smooth cspline  with lines       ls 3, \
     "output_single.log"     using         1:3   title 'Single'                   with      points ls 4, \
     "output_single.log"     using         1:3 notitle            smooth cspline  with lines       ls 4
#     "output_reversed.log"   using         1:3   title 'Reversed'                 with      points ls 2, \
#     "output_reversed.log"   using         1:3 notitle                            with lines       ls 2, \
