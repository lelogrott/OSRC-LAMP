...
plot "data_cp_mininet/times"        using 1:3   title 'Mininet'         with linespoints ls 1, \
      mean_y1                                   title 'Média'           with lines       ls 7, \
      mean_y1+stddev_y1                         title 'Desvio Padrão'   with lines       ls 8, \
      mean_y1-stddev_y1                       notitle                   with lines       ls 8
