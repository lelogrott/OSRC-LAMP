...
set output 'taxa_compare_raw.png'
...
plot "1024_log"        using (($0) * 1 + 1):1 title "1024 Mb"            with lines ls 1, \
     "768_log"         using (($0) * 1 + 1):1 title "768 Mb"             with lines ls 2, \
     "512_log"         using (($0) * 1 + 1):1 title "512 Mb"             with lines ls 3, \
     "256_log"         using (($0) * 1 + 1):1 title "256 Mb"             with lines ls 4
